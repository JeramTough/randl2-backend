...
public class RegisteredUserServiceImpl extends BaseServiceImpl<RegisteredUserMapper,
    ...
    private RegisteredUserPlantGetter registeredUserPlantGetter;

    @Autowired
    public RegisteredUserServiceImpl(WebApplicationContext wc,
                                     MapperFacade mapperFacade,
                                     RegisteredUserPlantGetter registeredUserPlantGetter) {
    ...
    public String verifyPhoneOrEmailForNew(VerifyPhoneOrEmailForNewParams params) {
        ...
        registeredUserPlantGetter.setRegisterUserWay(registerUserWay);
        RegisteredUserPlant plant = registeredUserPlantGetter.getRegisteredUserPlant(7000);
        plant.setAccount(params.getPhoneOrEmail(), 7001, 7003);
        return "该账号可以注册";
    }
    ...
    public String verifyPassword(VerifyPasswordParams params) {
        BeanValidator.verifyDto(params);
        RegisteredUserPlant plant = registeredUserPlantGetter.getRegisteredUserPlant(7000);
        plant.setPassword(params.getPassword(), params.getRepeatedPassword(), 7020);
        return "密码校验通过";
    }
