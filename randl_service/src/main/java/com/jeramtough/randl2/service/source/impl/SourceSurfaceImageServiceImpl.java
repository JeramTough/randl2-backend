package com.jeramtough.randl2.service.source.impl;
 ...
 */
@Service
public class SourceSurfaceImageServiceImpl extends BaseDtoServiceImpl<SourceSurfaceImageMapper,
        SourceSurfaceImage, SourceSurfaceImageDto> implements SourceSurfaceImageService, WithLogger {

    private RandlUserMapper randlUserMapper;

    @Autowired
    public SourceSurfaceImageServiceImpl(WebApplicationContext wc,
