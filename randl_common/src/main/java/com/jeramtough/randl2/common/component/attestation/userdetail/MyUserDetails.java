...
public class MyUserDetails implements UserDetails, CredentialsContainer {
    ...
    private static final Logger logger = LoggerManager.getLogger(MyUserDetails.class);
    ...
    public MyUserDetails(SystemUser systemUser) {
        ...
        this.enabled = systemUser.getAccountStatus() == AccountStatus.ABLE.getNumber();
    ...
    public static class UserBuilder {
        ...
        public UserDetails build() {
            ...
            return new MyUserDetails(username, encodedPassword, !disabled,
                    !accountExpired,
