 ...
 * @author Luke Taylor
 */
public abstract class AbstractAuthenticationProcessingFilter2 extends GenericFilterBean
     ...
     */
    protected AbstractAuthenticationProcessingFilter2(String defaultFilterProcessesUrl) {
     ...
     */
    protected AbstractAuthenticationProcessingFilter2(
    ...
    protected boolean requiresAuthentication(HttpServletRequest request,
        ...
        if (this.logger.isTraceEnabled()) {
            this.logger
                    .trace(LogMessage.format("Did not match request to %s",
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        if (this.logger.isDebugEnabled()) {
            this.logger.debug(
                    LogMessage.format("Set SecurityContextHolder to %s", authResult));
        }
